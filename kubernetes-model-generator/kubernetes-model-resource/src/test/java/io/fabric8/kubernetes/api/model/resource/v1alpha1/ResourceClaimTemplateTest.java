...
class ResourceClaimTemplateTemplateTest {
  ...
  void deserializationAndSerializationShouldWorkAsExpected() throws IOException {
    ...
    assertThat(resourceClaimTemplate)
        ...
        .hasFieldOrPropertyWithValue("spec.spec.allocationMode", "allocationModeValue")
        ...
        .hasFieldOrPropertyWithValue("spec.spec.resourceClassName", "resourceClassNameValue");
  }
  ...
  void builderShouldCreateObject() {
    ...
    ResourceClaimTemplateBuilder resourceClaimTemplateBuilder = new ResourceClaimTemplateBuilder()
        ...
        .endParametersRef()
        .withAllocationMode("allocationModeValue")
        .withResourceClassName("resourceClassNameValue")
        .endSpec()
        .endSpec();
