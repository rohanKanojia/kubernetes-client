...
public class ResourceClaim implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public ResourceClaim(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ResourceClaimSpec spec, ResourceClaimStatus status) {
        super();
