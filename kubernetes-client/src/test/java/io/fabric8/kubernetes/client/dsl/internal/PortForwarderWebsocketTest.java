...
class PortForwarderWebsocketTest {
  private final OkHttpClient mockOkHttpClient = Mockito.mock(OkHttpClient.class, Mockito.RETURNS_DEEP_STUBS);

  private PortForwarderWebsocket portForwarderWebsocket;

  @BeforeEach
  void initPortForwarderWebsocket() {
    this.portForwarderWebsocket = new PortForwarderWebsocket(mockOkHttpClient);
  }
